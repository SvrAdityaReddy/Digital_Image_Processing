...
sobelx = cv2.Sobel(img_grey,cv2.CV_8U,1,0,ksize=3)
sobely = cv2.Sobel(img_grey,cv2.CV_8U,0,1,ksize=3)
...
cv2.imwrite("/home/aditya/DIP/DIP17_1_Images/pipe_x_+_y_edge_GREY.jpeg",sobelx + sobely)