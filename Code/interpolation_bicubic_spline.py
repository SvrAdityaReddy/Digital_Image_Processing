...
f = interpolate.interp2d(x,y,small,kind='cubic')
xnew = range(0,256,1)
ynew = range(0,256,1)
interpolated = f(xnew,ynew)
print interpolated.shape
cv2.imwrite("/home/aditya/diptemp/cameraman_grey_bicubic_spline.png",interpolated)
...
print "Interpolation using bicubic spline"
...
f = interpolate.interp2d(x,y,small2,kind='cubic')
xnew = range(0,256,1)
ynew = range(0,256,1)
interpolated = f(xnew,ynew)
print interpolated.shape
cv2.imwrite("/home/aditya/diptemp/lena_bicubic_spline.png",interpolated)
